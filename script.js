...
async function loadAnimationConfig() {
    try {
        ...
        animationConfig = {
            particles: { count: 50, speed: 2, size: 3, colors: ["#8B0000", "#ff0000", "#ff6b6b", "#1a0000"] },
...
class ParticleSystem {
    constructor(canvas) {
        ...
        this.particles = [];
        this.config = animationConfig.particles || { count: 50, speed: 2, size: 3, colors: ["#8B0000", "#ff0000", "#ff6b6b", "#1a0000"] };
